...
const ALL_COMMANDS = {
    ...
    // ─── 📥 Download / تحميل ──────────────────────────────────
    "github": "thmil/github", "git": "thmil/github", "مستودع": "thmil/github",
    ...
    "appteka": "thmil/appteka",

    "lyrics": "thmil/lyrics", "كلمات-أغنية": "thmil/lyrics",

    "spotify": "thmil/spotify", "سبوتيفاي": "thmil/spotify",
    "twitter": "thmil/twitter", "x": "thmil/twitter", "تويتر": "thmil/twitter",
    "gdrive": "thmil/gdrive", "drive": "thmil/gdrive", "جوجل-درايف": "thmil/gdrive", "درايف": "thmil/gdrive",
    ...
    "nano": "image/nano", "nanopro": "image/nano", "nanobanana": "image/nanobanana",
    "نانو": "image/nano", "نانو-برو": "image/nano", "نانوبنانا": "image/nanobanana",
    ...
    "brat-vd": "tools/brat-vd", "bratvd": "tools/brat-vd",
    ...
    "ping": "tools/ping", "status": "admin/status", "بينج": "tools/ping", "حالة": "admin/status",
    "credits": "tools/credits", "quota": "tools/credits", "كريدت": "tools/credits",

    "tempnum": "tools/tempnum", "getsms": "tools/tempnum",
    "tempmail": "tools/tempmail", "mail": "tools/tempmail", "email": "tools/tempmail",
    "بريد": "tools/tempmail", "ايميل": "tools/tempmail",

    "blur": "tools/blur", "ضباب": "tools/blur", "طمس": "tools/blur",

    "tomp3": "tools/tomp3", "toaudio": "tools/tomp3",
    "img2pdf": "tools/img2pdf", "topdf": "tools/img2pdf", "pdf": "tools/img2pdf",
    ...
    "tts": "tools/tts", "texttospeech": "tools/tts", "صوّت": "tools/tts", "نص-صوت": "tools/tts",
    "say": "tools/tts", "قل": "tools/tts", "صوت": "tools/tts", "قرأ": "tools/tts",

    "qr": "tools/qr", "qrcode": "tools/qr", "باركود": "tools/qr", "رمز-qr": "tools/qr",

    "ocr": "tools/ocr", "imgtotext": "tools/ocr", "صورة-نص": "tools/ocr", "استخرج-نص": "tools/ocr",

    "ss": "tools/screenshot", "screenshot": "tools/screenshot", "لقطة": "tools/screenshot", "ssweb": "tools/screenshot",

    "style": "tools/style", "font": "tools/style", "decoration": "tools/style",

    "ffnews": "tools/ffnews", "freefire": "tools/ffnews",

    "wc": "tools/worldcup", "worldcup": "tools/worldcup", "كأس-العالم": "tools/worldcup", "مونديال": "tools/worldcup", "المنتخبات": "tools/worldcup",
    ...
    "aljazeera": "morocco/aljazeera", "الجزيرة": "morocco/aljazeera",
    ...
    "stats": "admin/stats", "status": "admin/stats", "حالة": "admin/stats", "احصائيات": "admin/stats",
    "devmsgwa": "admin/broadcast", "devmsgtg": "admin/broadcast",
    "devmsgfb": "admin/broadcast", "devmsgig": "admin/broadcast",
    "devmsgtous": "admin/broadcast", "devmsgall": "admin/broadcast",
    "menuadmin": "admin/menuadmin", "قائمة-الادمن": "admin/menuadmin",
    ...
    "زيادة-متابعين": "admin/instaboost", "رشق-زيارات": "admin/instaboost",

    "igfollowers": "tools/igfollowers", "رشق": "tools/igfollowers", "متابعين": "tools/igfollowers",

    // ─── 📞 Truecaller / Phone Lookup ────────────────────────────
    "truecaller": "tools/truecaller", "trueller": "tools/truecaller",
    "تروكولر": "tools/truecaller", "num": "tools/truecaller",
    "رقم": "tools/truecaller", "numcheck": "tools/truecaller",

    "mega": "info/mega", "automation": "info/mega", "ميجا": "info/mega",
    "autopost": "admin/autopost", "autonews": "admin/autonews", "اخبار-تلقائية": "admin/autonews", "expert": "ai/expert", "brainstorm": "ai/expert",
    "news": "info/news", "أخبار": "info/news", "akhbar": "info/news",
    "price": "info/price", "سعر": "info/price",

    // ─── 📋 Menu / Info ──────────────────────────────────────────
    "menu": "info/menu", "help": "info/menu", "start": "info/menu",
    "قائمة": "info/menu", "مساعدة": "info/menu", "اوامر": "info/menu",
    "stats": "admin/stats", "status": "admin/stats",
    "ping": "tools/ping", "بينج": "tools/ping",
    "msgtodev": "info/msgtodev",
};
 ...
 */
const NLC_KEYWORDS = {
    "مستودع|github|git": "thmil/github",
    ...
    "سبوتيفاي|spotify": "thmil/spotify",
    "تويتر|twitter|x.com": "thmil/twitter",
    "بريد مؤقت|ايميل مؤقت|tempmail": "tools/tempmail",
    "حالة البوت|stats": "admin/stats",
    "اوامر الادمن|menuadmin": "admin/menuadmin",
    "قائمة|menu|help": "info/menu",
    "رشق|متابعين|igfollowers": "tools/igfollowers",
    "عدل|تعديل|3dl|edit|aiedit": "image/aiedit",
    "pdf|بيديف|الصور الى pdf": "tools/img2pdf",
    "tts|say|texttospeech|صوّت|نص-صوت|قل|صوت|قرأ": "tools/tts",
    "qr|qrcode|باركود": "tools/qr",
    "ocr|imgtotext|صورة-نص|استخرج-نص": "tools/ocr",
    "ss|screenshot|لقطة-شاشة": "tools/screenshot",
    "sticker|ملصق": "tools/sticker",
    "جوجل درايف|gdrive|drive|درايف": "thmil/gdrive",
    "تروكولر|truecaller|trueller|معرفة الرقم|صاحب الرقم|بحث عن رقم": "tools/truecaller",
};

function isQuestionOrInquiry(text) {
    ...
    const questionPatterns = [
        ...
        // Modern Standard Arabic Question Words
        /(^|\s)كيف(\s|$)/,
        /(^|\s)هل(\s|$)/,
        /(^|\s)أين(\s|$)/,
        /(^|\s)متى(\s|$)/,
    ...
    const isQuestion = questionPatterns.some(regex => regex.test(lower));
    const endsWithQuestionMark = lower.endsWith('?') || lower.endsWith('؟');

    if (endsWithQuestionMark && lower.length > 12) {
        return true;
    }
...
async function handleAutoDownload(text, sock, chatId, msg, extra = {}) {
    if (!text) return false;
    const lowerText = text.toLowerCase().trim();
    
    // 1. Instagram
    if (/instagram\.com\/(p|tv|stories|reel)\//i.test(lowerText) || /instagram\.com\/reel\//i.test(lowerText) || /instagram\.com\/reels\//i.test(lowerText)) {
        try {
            const igCmd = require('../commands/thmil/ig');
            await igCmd(sock, chatId, msg, [text], extra, "ar");
            return true;
        } catch (e) {
            console.error('[AutoDownload IG Error]:', e.message);
        }
    }
    
    // 2. Facebook
    if (/facebook\.com|fb\.watch/i.test(lowerText)) {
        try {
            const fbCmd = require('../commands/thmil/fb');
            await fbCmd(sock, chatId, msg, [text], extra, "ar");
            return true;
        } catch (e) {
            console.error('[AutoDownload FB Error]:', e.message);
        }
    }
    
    // 3. TikTok
    if (/tiktok\.com/i.test(lowerText)) {
        try {
            const tiktokCmd = require('../commands/thmil/tiktok');
            await tiktokCmd(sock, chatId, msg, [text], extra, "ar");
            return true;
        } catch (e) {
            console.error('[AutoDownload TikTok Error]:', e.message);
        }
    }
    
    // 4. YouTube
    if (/youtube\.com|youtu\.be/i.test(lowerText)) {
        try {
            const ytvCmd = require('../commands/thmil/ytv');
            await ytvCmd(sock, chatId, msg, [text], extra, "ar");
            return true;
        } catch (e) {
            console.error('[AutoDownload YouTube Error]:', e.message);
        }
    }
    
    // 5. CapCut
    if (/capcut\.com/i.test(lowerText)) {
        try {
            const capcutCmd = require('../commands/thmil/capcut');
            await capcutCmd(sock, chatId, msg, [text], extra, "ar");
            return true;
        } catch (e) {
            console.error('[AutoDownload CapCut Error]:', e.message);
        }
    }
    
    // 6. Twitter/X
    if (/twitter\.com|x\.com/i.test(lowerText)) {
        try {
            const twitterCmd = require('../commands/thmil/twitter');
            await twitterCmd(sock, chatId, msg, [text], extra, "ar");
            return true;
        } catch (e) {
            console.error('[AutoDownload Twitter Error]:', e.message);
        }
    }
...
module.exports = { ALL_COMMANDS, NLC_KEYWORDS, isQuestionOrInquiry, handleAutoDownload };
