...
function startTelegramBot(manualToken) {
    ...
    bot.on('polling_error', (err) => {
        ...
        if (msg.includes('409') || msg.includes('Conflict')) {
            console.warn(chalk.yellow(`[Telegram] Polling conflict detected (409). Another instance may be running. Stopping this poller.`));
            ...
            // Transient network error — log only, don't crash
