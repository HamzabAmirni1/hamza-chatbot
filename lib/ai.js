...
function getSystemPrompt(text, isVision = false) {
    ...
    if (isVision) {
        return lang === 'ar' 
            ? "أنت مساعد ذكي خبير في تحليل الصور. لقد أرسل لك المستخدم صورة مرفقة؛ قم بمراجعتها ووصفها بدقة وباللغة العربية أو الدارجة المغربية." 
            : "You are an expert image analyzer. The user has provided an image; please analyze and describe it in detail in English.";
    }
