                ...
                if (type === 'imageMessage' || type === 'videoMessage') {
                    ...
                    try {
                        ...
                        if (isVideo) {
                            ...
                            let prompt;
                            if (isExercise) {
                                prompt = `تصرف كأستاذ ذكي وخبير. المطلوب منك هو حل التمرين أو السؤال الموجود في الصورة حلاً كاملاً ومفصلاً خطوة بخطوة. اشرح الطريقة والنتيجة بوضوح. طلب المستخدم: ${caption}`;
                            } else if (caption.length > 2) {
                                prompt = `أجب على هذا السؤال أو الطلب بناءً على محتوى الصورة: ${caption}`;
                            } else {
                    ...
                    if (quotedType === 'imageMessage' || quotedType === 'documentWithCaptionMessage') {
                        ...
                        try {
                            ...
                            if (isExercise) {
                                ...
                                caption = textInCmd ? `أجب على السؤال التالي بناءً على محتوى الصورة: ${textInCmd}` : "صف ما يوجد في هذه الصورة بالتفصيل.";
                            }
