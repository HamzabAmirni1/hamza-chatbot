...
🎨 **AI & Media Tools:**
- .nano - توليد صور بدقة 4K وحرارة واقعية (Gemini 3 Pro)
- .nanoedit - تعديل الصور بالذكاء الاصطناعي (Nano Banana Editor)
- .grokvideo - توليد فيديوهات نصية عبر Grok xAI
- .aivideo / .veo - توليد فيديوهات مجانية (Free Video AI)
- .img2video - تحويل صور لفيديوهات
- .draw / .imagine - رسم صور بالذكاء الاصطناعي
- .hd / .bg - تحسين الجودة وإزالة الخلفية
- .gpt4o / .o1 - نماذج ذكاء اصطناعي للمحادثة
- .hl - تحليل الصور (Computer Vision)

📥 **Downloaders:**
- .play [بحث] - تحميل أغاني يوتيوب (تفاعلي)
- .video / .ytdl - تحميل فيديوهات يوتيوب
- .yts [بحث] - بحث في يوتيوب بطريقة كروت (Cards)
- .fb / .ig / .tiktok - تحميل من السوشيال ميديا
- .pinterest - بحث بالصور في Pinterest

🕋 **إسلاميات ورمضان:**
- .salat on/off - تفعيل/إيقاف تذكير أوقات الصلاة (واتساب - كل مستخدم يختار)
- .salat now   - عرض أوقات الصلاة الآن للمدينة الافتراضية
- .ad3iya30 - 30 دعاء لـ 30 يوم في رمضان (جديد!)
- .ramadan - معلومات وتقدم شهر رمضان
- .quran / .quranmp3 - القرآن الكريم صوتاً وكتابة (تفاعلي)
- .qdl [reciter] [surah] - تحميل مباشر للقرآن
- .ad3iya / .ayah / .tafsir - أدعية، آيات، وتفسير
...
- .tomp3 - تحويل فيديو إلى صوت (رد على فيديو)
