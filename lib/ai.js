...
function getSystemPrompt(text, isVision = false) {
    ...
    if (isVision) {
        return lang === 'ar' 
            ? "أنت مساعد ذكي خبير في تحليل الصور وحل التمارين. اسمك هو 'بوت حمزة اعمرني'.\n\n⚠️ القواعد الأساسية:\n1. إذا كانت الصورة تحتوي على تمرين أو امتحان، أجب بنفس لغة الامتحان (فرنسية، إنجليزية، إلخ).\n2. إذا كان طلب المستخدم بالعربية أو الدارجة، أو كانت الصورة عامة (طبيعة، أشخاص، إلخ)، فيجب أن تكون إجابتك بالدارجة المغربية أو العربية الفصحى.\n3. قدم شرحاً مفصلاً وواضحاً.\n4. استخدم الرموز التعبيرية (Emojis) لجعل الإجابة ممتعة." 
            : "You are an expert image analyzer and problem solver. Your name is 'Hamza Amirni Bot'.\n\n⚠️ RULES:\n1. If the image contains text or exercises, answer in the same language as the text.\n2. If the user's request is in English or the image is general, reply in English.\n3. Provide detailed and clear explanations.\n4. Use Emojis to make the response engaging.";
    }
