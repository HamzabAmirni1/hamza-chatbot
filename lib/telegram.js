...
function startTelegramBot(manualToken) {
    ...
    function getMainInlineKeyboard() {
        ...
        return {
            inline_keyboard: [
                ...
                [{ text: '🎬 AI فيديو', callback_data: 'menu_cat_video' }, { text: '📥 تحميل', callback_data: 'menu_cat_download' }],
                [{ text: '🕋 إسلامي', callback_data: 'menu_cat_islamic' }, { text: '🛠️ أدوات', callback_data: 'menu_cat_tools' }],
                [{ text: '🇲🇦 المغرب', callback_data: 'menu_cat_morocco' }, { text: 'ℹ️ معلومات', callback_data: 'menu_cat_info' }],
                [{ text: '📋 كل الأوامر', callback_data: 'menu_all' }],
    ...
    const MENU_CATEGORIES = {
        ...
        images: {
            ...
            cmds: [
                ...
                [{ text: '.sd 🖼️', callback_data: 'menu_cmd_sd' }, { text: '.deepimg 🤖', callback_data: 'menu_cmd_deepimg' }],
                [{ text: '.removebg 🗑️', callback_data: 'menu_cmd_removebg' }, { text: '.hd 📸', callback_data: 'menu_cmd_hd' }],
                [{ text: '.upscale ⬆️', callback_data: 'menu_cmd_upscale' }, { text: '.hdv3 🔆', callback_data: 'menu_cmd_hdv3' }],
                [{ text: '.colorize 🌈', callback_data: 'menu_cmd_colorize' }, { text: '.sketch ✏️', callback_data: 'menu_cmd_sketch' }],
                [{ text: '.wallpaper 🖼️', callback_data: 'menu_cmd_wallpaper' }, { text: '.brat 💚', callback_data: 'menu_cmd_brat' }],
                [{ text: '.draw 🖌️', callback_data: 'menu_cmd_draw' }, { text: '.aiedit 🛠️', callback_data: 'menu_cmd_aiedit' }],
                [{ text: '.blur 🌫️', callback_data: 'menu_cmd_blur' }],
                ...NAV
            ]
        },
        video: {
            title: '🎬 AI فيديو | AI Video',
            text: '🎬 *AI فيديو — AI Video*\n━━━━━━━━━━━━━━━━\n\n• `.img2video` — صورة إلى فيديو AI\n• `.aivideo / .veo` — نص إلى فيديو AI\n• `.grokvideo` — Grok Video AI',
            cmds: [
                [{ text: '.img2video 🎬', callback_data: 'menu_cmd_img2video' }, { text: '.aivideo 🎥', callback_data: 'menu_cmd_aivideo' }],
                [{ text: '.grokvideo 🤖', callback_data: 'menu_cmd_grokvideo' }],
                ...NAV
            ]
        },
        download: {
            ...
            cmds: [
                ...
                [{ text: '.capcut ✂️', callback_data: 'menu_cmd_capcut' }, { text: '.apk 📦', callback_data: 'menu_cmd_apk' }],
                [{ text: '.gdrive 📂', callback_data: 'menu_cmd_gdrive' }, { text: '.lyrics 🎶', callback_data: 'menu_cmd_lyrics' }],
                ...NAV
            ]
        },
        islamic: {
        ...
        tools: {
            ...
            cmds: [
                ...
                [{ text: '.tempmail 📧', callback_data: 'menu_cmd_tempmail' }, { text: '.tempnum 📞', callback_data: 'menu_cmd_tempnum' }],
                ...
                [{ text: '.ocr 📄', callback_data: 'menu_cmd_ocr' }, { text: '.ss 🖥️', callback_data: 'menu_cmd_ss' }],
                [{ text: '.style 🔤', callback_data: 'menu_cmd_style' }, { text: '.igfollowers 👥', callback_data: 'menu_cmd_igfollowers' }],
                ...NAV
            ]
        },
        morocco: {
            ...
            cmds: [
                ...
                [{ text: '.price 💰', callback_data: 'menu_cmd_price' }],
                ...NAV
            ]
        },
        info: {
    ...
    bot.on('message', async (msg) => {
        ...
        try {
            ...
            const cmdMatch = body.match(/^[\.\/]([a-zA-Z0-9\u0600-\u06FF\-_]+)(\s+.*|$)/i);
