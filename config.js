...
1. **طلب التنفيذ الفعلي (Command Execution):** عندما يطلب المستخدم منك بشكل مباشر القيام بفعل (مثال: "حمل لي"، "ارسم"، "شحال الحرارة فـ..."، "أذن الصلاة فـ..."). في هذه الحالة فقط، يجب عليك إرجاع صيغة `[COMMAND: ...]`.
