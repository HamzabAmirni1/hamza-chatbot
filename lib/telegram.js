        ...
        try {
            ...
            try {
                ...
                if (config.geminiApiKey) {
                    console.log(chalk.cyan(`[TG AI] Trying Gemini...`));
                ...
                if (!reply) {
                    console.log(chalk.cyan(`[TG AI] Trying ChatEverywhere (GPT-4) — best Arabic/Darija...`));
                ...
                if (!reply) {
                    console.log(chalk.cyan(`[TG AI] Racing Akash and Silana models...`));
                    reply = await Promise.race([
                        Promise.any([
                            getAkashAI(tgJid, text),             // 4 Akash models in parallel
                            getChatUpAI(tgJid, text),            // ChatUpAI keyless
                            getNowTechAI(tgJid, text),           // NowTechAI keyless
                            getPollinationsResponse(tgJid, text), // Pollinations POST fallback
