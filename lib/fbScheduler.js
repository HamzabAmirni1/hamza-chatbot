...
async function generatePostText(prompt) {
    const postPrompt = `أنت خبير في التنمية الذاتية، الثقافة المغربية، والعلوم الإسلامية.
المطلوب: اكتب منشور فيسبوك (Facebook Post) احترافي ومفيد باللغة العربية حول: "${prompt}"

⚠️ قواعد ذهبية وصارمة:
1. الدقة الدينية: يُمنع منعاً باتاً اختراع أحاديث نبوية أو آيات قرآنية. إذا كنت ستذكر حديثاً، يجب أن يكون مشهوراً وصحيحاً (رواه البخاري أو مسلم). إذا لم تكن متأكداً 100%، اكتفِ بنصيحة عامة بأسلوب إسلامي راقٍ دون نسبتها للنبي ﷺ.
2. الثقافة المغربية: استخدم أمثالاً مغربية أصيلة وحكماً شعبية (مثل: خوك تمضغ ليه، ما تبلع ليه / لي فاتك بالزين فوتو بالنظافة...).
3. التنسيق: 
   - ممنوع استخدام النجوم (**) لأن فيسبوك لا يدعمها وتظهر كرموز.
   - استخدم الإيموجي المناسب في كل فقرة.
   - البعد عن الرتابة: فقرات قصيرة، فواصل جميلة (مثل ━━━━━━━━━━━━━━━━━━).
4. اللغة: مزيج بين العربية الفصحى البسيطة والدارجة المغربية "المهذبة" والمفهومة للجميع.
5. الهاشتاقات: أضف هاشتاقات نشطة (مثل: #المغرب #نصيحة #حكمة #تطوير_الذات).
6. البداية: ابدأ مباشرة بالمحتوى، لا تضع "إليك المنشور" أو أي كلام جانبي.

الهدف هو تقديم محتوى يفتخر به القارئ ويشاركه مع أصدقائه. المحتوى يجب أن يكون وقوراً وموثوقاً.`;
