    ...
    const MENU_CATEGORIES = {
        ...
        download: {
            ...
            cmds: [
                ...
                [{ text: '.lyrics 🎶', callback_data: 'menu_cmd_lyrics' }, { text: '.tomp3 🎧', callback_data: 'menu_cmd_tomp3' }, { text: '.gdrive 📂', callback_data: 'menu_cmd_gdrive' }],
                [{ text: '🔙 رجوع', callback_data: 'menu_main' }, { text: '❌ إغلاق', callback_data: 'menu_close' }]
            ]
        },
        islamic: {
        ...
        tools: {
            ...
            cmds: [
                ...
                [{ text: '.mega 📦', callback_data: 'menu_cmd_mega' }, { text: '.owner 👤', callback_data: 'menu_cmd_owner' }, { text: '.msgtodev 📬', callback_data: 'menu_cmd_msgtodev' }],
                [{ text: '🔙 رجوع', callback_data: 'menu_main' }, { text: '❌ إغلاق', callback_data: 'menu_close' }]
            ]
        },
        admin: {
